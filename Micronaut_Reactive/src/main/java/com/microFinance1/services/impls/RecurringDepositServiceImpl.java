...
public class RecurringDepositServiceImpl implements RecurringDepositService {
    ...
    @Transactional
    protected Mono<RecurringDeposit> setPayment(RecurringDeposit recurringDeposit, PaymentStatus paymentStatus, int i) {
    ...
    @Transactional
    protected Mono<TransactionOutputDto> setTransaction(RecurringDeposit recurringDeposit, String status, Double monthlyPaidAmount) {
