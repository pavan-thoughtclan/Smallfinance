...
//        Transaction transaction = TransactionMapper.MAPPER.mapToTransaction(transactionInputDto);
...
//        TransactionOutputDto transactionOutputDto = modelMapper.map(transactionOutputDtotion,TransactionOutputDto.class);
//        TransactionOutputDto transactionOutputDto = TransactionMapper.INSTANCE.mapToTransactionOutputDto(transaction);
